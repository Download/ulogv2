...
// var ulog = require('./')
// var testConsole = ulog.outputs.test = require('./test/console')(sandbox)


// describe('ulog: function([name] [, options]) => log', () => {
// 	beforeEach(() => {
...
// 	it('is a function', () => {
// 		expect(ulog).to.be.a('function')
// 	})

// 	it('can be called with a name to create a logger', () => {
// 		var log = ulog('name')
// 		expect(log).to.not.be.undefined
// 	})

// 	it('returns the same object when called with the same name', () => {
// 		var expected = ulog('name')
// 		var actual = ulog('name')
// 		expect(actual).to.equal(expected)
// 	})

// 	it('can be called without arguments to get a map of all loggers keyed by name', () => {
// 		var name = 'test'
// 		var expected = ulog(name)
// 		var loggers = ulog()
// 		expect(loggers).to.have.a.property(name)
// 		var actual = loggers[name]
// 		expect(actual).to.equal(expected)
// 	})

// 	it('has a property `level`', () => {
// 		expect(ulog).to.have.a.property('level')
// 	})

// 	/*
// 	describe('log: function([level=\'log\'] [, ...args])', () => {
// 		var log = ulog('name')
